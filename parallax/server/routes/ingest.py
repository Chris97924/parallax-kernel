...
@router.post("/memory", response_model=IngestResponse, status_code=status.HTTP_201_CREATED)
...
@router.post("/claim", response_model=IngestResponse, status_code=status.HTTP_201_CREATED)
